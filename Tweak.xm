...
%ctor{
    CFNotificationCenterAddObserver(CFNotificationCenterGetDistributedCenter(),NULL,(CFNotificationCallback)shareSnap,CFSTR("com.jontelang.snapper2.sharesnap2GRR"),NULL,CFNotificationSuspensionBehaviorCoalesce);
